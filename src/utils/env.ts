...
export const ENV = {
  SUPABASE_URL: getEnv('SUPABASE_URL', 'https://oqletqwsduwpfbigkmyo.supabase.co'),
  SUPABASE_ANON_KEY: getEnv('SUPABASE_ANON_KEY', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xbGV0cXdzZHV3cGZiaWdrbXlvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDc1MDcwMDUsImV4cCI6MjA2MzA4MzAwNX0.Y6HTKN1MoGD02NRTCYJQKXBAWv-JtlFzX-V_pq96jW4'),
